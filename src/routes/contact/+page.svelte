<script>
	...
	function validateField(fieldName) {
		...
		} else if (rules.pattern && value.trim() && !rules.pattern.test(value.trim())) {
	...
	function validateForm() {
		return Object.keys(formData).every(fieldName => validateField(fieldName));
	}
...
<svelte:head>
	...
	<meta name="description" content="Get in touch with the BMSC ICT Club. Send us a message or visit us at BIAM Model School & College, Bogura." />
</svelte:head>
...
<section class="relative py-24 lg:py-32 overflow-hidden">
	...
	<div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
		<ScrollReveal>
			<div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary-400 mb-6">
				<span class="w-2 h-2 rounded-full bg-primary-400"></span>
				Get in Touch
			</div>
			<h1 class="text-4xl lg:text-6xl font-bold font-heading text-white mb-6">
			...
			<div class="lg:col-span-3">
				<ScrollReveal>
					<div class="glass-card p-8">
						<h2 class="text-2xl font-bold font-heading text-white mb-6">Send a Message</h2>

						<form on:submit={handleSubmit} class="space-y-5">
							<div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
								<div>
									<label for="name" class="text-sm text-gray-400 font-medium block mb-1.5">Full Name *</label>
									<input type="text" id="name" name="name" bind:value={formData.name} on:input={handleInputChange}
								...
								<div>
									<label for="email" class="text-sm text-gray-400 font-medium block mb-1.5">Email *</label>
									<input type="email" id="email" name="email" bind:value={formData.email} on:input={handleInputChange}
										class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500
											focus:outline-none focus:border-primary-500/50 focus:ring-1 focus:ring-primary-500/30 transition-all"
							...
							<div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
								<div>
									<label for="phone" class="text-sm text-gray-400 font-medium block mb-1.5">Phone</label>
									<input type="tel" id="phone" name="phone" bind:value={formData.phone} on:input={handleInputChange}
										class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500
											focus:outline-none focus:border-primary-500/50 focus:ring-1 focus:ring-primary-500/30 transition-all"
								...
								<div>
									<label for="subject" class="text-sm text-gray-400 font-medium block mb-1.5">Subject *</label>
									<input type="text" id="subject" name="subject" bind:value={formData.subject} on:input={handleInputChange}
										class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500
											focus:outline-none focus:border-primary-500/50 focus:ring-1 focus:ring-primary-500/30 transition-all"
										placeholder="What's this about?" required />
									{#if errors.subject}<p class="text-red-400 text-xs mt-1">{errors.subject}</p>{/if}
								</div>
							</div>

							<div>
								<label for="message" class="text-sm text-gray-400 font-medium block mb-1.5">Message *</label>
								<textarea id="message" name="message" bind:value={formData.message} on:input={handleInputChange}
									rows="5"
									class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500
			...
			<div class="lg:col-span-2 space-y-6">
				<ScrollReveal delay={100}>
					<div class="glass-card p-6 space-y-5">
						<h3 class="text-xl font-bold font-heading text-white">Contact Information</h3>
						...
						<div class="flex items-start gap-3 p-3 rounded-lg bg-white/3">
							...
							<div>
								<p class="text-sm text-gray-400 mb-0.5">Address</p>
								<p class="text-white text-sm">BIAM Model School & College, Bogura</p>
							</div>
						</div>
						...
						<div class="flex items-start gap-3 p-3 rounded-lg bg-white/3">
							...
							<div>
								...
								<p class="text-white text-sm">info@bmscictclub.com</p>
							</div>
						</div>
						...
						<div class="flex items-start gap-3 p-3 rounded-lg bg-white/3">
							...
							<div>
								<p class="text-sm text-gray-400 mb-0.5">Phone</p>
								<p class="text-white text-sm">+880 1234-567890</p>
							</div>
						</div>
					</div>
				</ScrollReveal>
				...
				<ScrollReveal delay={200}>
					<div class="glass-card p-6">
						<h3 class="text-xl font-bold font-heading text-white mb-4">Office Hours</h3>
						<div class="space-y-2 text-sm">
							<div class="flex justify-between text-gray-300">
								<span>Monday – Friday</span>
								<span class="text-primary-400">9:00 AM – 5:00 PM</span>
							</div>
							<div class="flex justify-between text-gray-300">
								<span>Saturday</span>
								<span class="text-primary-400">9:00 AM – 1:00 PM</span>
							</div>
							<div class="flex justify-between text-gray-300">
								<span>Sunday</span>
				...
				<ScrollReveal delay={300}>
					<div class="glass-card p-6">
						<h3 class="text-xl font-bold font-heading text-white mb-4">Follow Us</h3>
						<div class="flex gap-3">
							<a href="https://facebook.com/bmscictclub.bogura" target="_blank" rel="noopener noreferrer"
							...
							<a href="https://instagram.com/bmscictclub" target="_blank" rel="noopener noreferrer"
							...
							<a href="https://github.com/bmscictclub" target="_blank" rel="noopener noreferrer"
