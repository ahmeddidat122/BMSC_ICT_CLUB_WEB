...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/api/courses": { id?: string | undefined };
			"/api/courses/[id]": { id: string };
			"/api/courses/[id]/progress": { id: string };
			"/api/discussions": { id?: string | undefined };
			"/api/discussions/[id]": { id: string };
			"/api/discussions/[id]/reply": { id: string };
			...
			"/courses": { id?: string | undefined };
			"/courses/[id]": { id: string };
			"/dashboard": Record<string, never>;
			"/login": Record<string, never>;
			"/notices": { id?: string | undefined };
			"/notices/[id]": { id: string };
		...
		Pathname(): "/" | "/admin" | "/api/badges" | "/api/contact" | "/api/courses" | `/api/courses/${string}/progress` & {} | "/api/discussions" | `/api/discussions/${string}/reply` & {} | "/api/notices" | "/api/projects" | "/api/team" | "/api/users" | `/api/users/${string}/achievements` & {} | `/api/users/${string}/stats` & {} | "/auth/callback" | "/community" | `/community/${string}` & {} | "/contact" | "/courses" | `/courses/${string}` & {} | "/dashboard" | "/login" | "/notices" | `/notices/${string}` & {} | "/projects" | "/robots.txt" | "/sitemap.xml" | "/team";
